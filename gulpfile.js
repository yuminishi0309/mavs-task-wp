...
// フォントファイルをテーマへコピー
function fontPipe(done) {
  src('app/product/assets/font/**/*.+(eot|svg|ttf|woff|woff2)')
  .pipe(plumber())
  .pipe(dest(`themes/${themeName}/assets/font`))
...
function watchTask(done) {
  ...
  watch(["app/product/assets/font/**/*.+(eot|svg|ttf|woff|woff2)"], series(fontPipe))
